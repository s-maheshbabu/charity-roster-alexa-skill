...
it("contains an APL directive in the response if the device supports Alexa Presentation Language Interface", async () => {
...
it("doesn't contain an APL directive if the device does not support Alexa Presentation Language Interface", async () => {
